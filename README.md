...
| **PremiumToken** | + Buy/Sell tax collection, manual swap, tax controls, Anti-whale | Premium |
...
- **No auto-liquidity** — Premium tax tokens are collected in the contract and handled manually
...
Premium token with tax collection, manual swap, tax controls, anti-whale protections, and all Standard features.
